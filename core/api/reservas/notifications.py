...
Por favor, revisa y confirma la disponibilidad de recursos para la nueva fecha.
            ...
            if reserva.numero_reprogramaciones >= 3:
                prioridad = TicketSoporte.PrioridadSolicitud.ALTA
            elif reserva.numero_reprogramaciones >= 2:
                prioridad = TicketSoporte.PrioridadSolicitud.MEDIA
            else:
                prioridad = TicketSoporte.PrioridadSolicitud.BAJA

            # Crear notificación en el panel de soporte
            solicitud = TicketSoporte.objects.create(
                cliente=reserva.usuario,
                tipo_solicitud=TicketSoporte.TipoSolicitud.REPROGRAMACION,
                prioridad=prioridad,
                asunto=asunto,
