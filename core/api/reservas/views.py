...
from core.models import Reserva, Acompanante, ReservaAcompanante, HistorialReprogramacion
...
class GestionConfiguracionAPIView(APIView):
    ...
    def get(self, request):
        ...
        from core.models import ReglasReprogramacion, ConfiguracionGlobalReprogramacion
